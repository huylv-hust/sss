    ...
    <article>
        <section class ="preview">
            ...
            <table border="1px">
                <tr>
                    ...
                    <td colspan="5" class="width5 sizeup"><?php echo $detail['D01_CUST_NAMEK']; ?></td>
                    <th colspan="4" class="width4">受付日</th>
                    <th colspan="5" class="width5">受付時間</th>
                </tr>
                <tr class="height2">
                    <td colspan="7" class="sizeup"><?php echo $detail['D01_CUST_NAMEN']; ?> 様</td>
                    <td colspan="4" class="sizeup"><?php echo isset($detail['D03_UPD_DATE']) ? Yii::$app->formatter->asDate($detail['D03_UPD_DATE'], 'yyyy年MM月dd日') : date('Y年m月d日'); ?></td>
                    <td colspan="5">
                        <span class="sizeup"><?php echo isset($detail['D03_AZU_BEGIN_HH']) ? str_pad($detail['D03_AZU_BEGIN_HH'], 2, '0', STR_PAD_LEFT) : str_pad('00', 2, '0', STR_PAD_LEFT); ?>:<?php echo isset($detail['D03_AZU_BEGIN_MI']) ? str_pad($detail['D03_AZU_BEGIN_MI'], 2, '0', STR_PAD_LEFT) : str_pad('00', 2, '0', STR_PAD_LEFT); ?></span>
                        <span>～</span>
                        <span class="sizeup"><?php echo isset($detail['D03_AZU_END_HH']) ? str_pad($detail['D03_AZU_END_HH'], 2, '0', STR_PAD_LEFT) : str_pad('00', 2, '0', STR_PAD_LEFT); ?>:<?php echo isset($detail['D03_AZU_END_MI']) ? str_pad($detail['D03_AZU_END_MI'], 2, '0', STR_PAD_LEFT) : str_pad('00', 2, '0', STR_PAD_LEFT); ?></span>
                    </td>
                </tr>
            </table>
        </section>
        <section class ="preview">
            ...
            <table border="1px">
                ...
                <tr>
                    <td colspan="4" class="width4"><?php echo $car['D02_MAKER_CD'] ? $car['D02_MAKER_CD'] : 'その他'?></td>
                    <td colspan="4" class="width4"><?php echo $detail['D03_CAR_NAMEN']; ?></td>
                ...
                <tr>
                    <td colspan="4" class="width4"><?php echo $detail['D03_JIKAI_SHAKEN_YM'] != '' ? Yii::$app->formatter->asDate(date('d-M-y', strtotime($detail['D03_JIKAI_SHAKEN_YM'])), 'yyyy年MM月dd日') : '' ?></td>
                    <td colspan="4" class="width4"><?php echo $detail['D03_METER_KM'] ? $detail['D03_METER_KM'].'<span>Km</span>' : ''; ?></td>
                    <td colspan="3" class="width3"><?php echo $detail['D02_SYAKEN_CYCLE'] ? $detail['D02_SYAKEN_CYCLE'].'<span>年</span>' : ''; ?></td>
                    <td colspan="5" class="width3">
                        <?php echo $detail['D03_RIKUUN_NAMEN']?>
                        <?php echo $detail['D03_CAR_ID']?>
                        <?php echo $detail['D03_HIRA']?>
                        <?php echo $detail['D03_CAR_NO']?>
                    </td>
                </tr>
            </table>
        </section>
            ...
            <table border="1px">
                ...
                <tr>
                    <td colspan="4" class="width4">
                        <span style="width: 30px" class="<?php if (isset($detail['D03_KITYOHIN']) && $detail['D03_KITYOHIN'] == 1) {
                            echo 'rcorners';
                        } ?>">　有　</span>
                        <span>　　・　　</span>
                        <span style="width: 30px" class="<?php if (isset($detail['D03_KITYOHIN']) && $detail['D03_KITYOHIN'] == 0) {
                            echo 'rcorners';
                        } ?>">　無　</span>
                    </td>
                    <td colspan="4" class="width4">
                    ...
                    <td colspan="8" class="width8">
                        ...
                        <span>・</span>
                        <?php if (isset($detail['D03_SEISAN']) && $detail['D03_SEISAN'] == 1) {
                            echo '<span class="rcorners">　プリカ　</span>';
                        }else{
                            echo '<span>　プリカ　</span>';
                        }?>
                        <span>・</span>
                        <?php if (isset($detail['D03_SEISAN']) && $detail['D03_SEISAN'] == 2) {
                            echo '<span class="rcorners">　クレジット　</span>';
                        }else{
                            echo '<span>　クレジット　</span>';
                        }?>
                        <span>・</span>
                        <?php if (isset($detail['D03_SEISAN']) && $detail['D03_SEISAN'] == 3) {
        ...
        <section class ="preview">
            ...
            <table border="1px">
                ...
                <?php
                $count = 10;//count($detail['product']) > 5 ? count($detail['product']) : 5;
                for ($k = 0; $k < $count; $k++) {
                    if (isset($detail['product'][$k])) {
                        ?>
                        <tr>
                            <td colspan="5" class="tleft">
                                <span><?php echo isset($detail['product'][$k]['M05_COM_NAMEN']) ? $detail['product'][$k]['M05_COM_NAMEN'] : ''; ?></span>
                            </td>
                            <td colspan="3">
                                <span><?php echo $detail['product'][$k]['D05_COM_CD'].$detail['product'][$k]['D05_NST_CD']?></span>
                            </td>
                            <td colspan="2">
                                <span><?php echo $detail['product'][$k]['D05_SURYO'] < 1 ? '0'.$detail['product'][$k]['D05_SURYO'] : $detail['product'][$k]['D05_SURYO']; ?></span>
                            </td>
                            <td class="tright" colspan="3">
                                <span class="rtab"><?php echo isset($detail['product'][$k]['D05_TANKA']) && $detail['product'][$k]['D05_TANKA'] != '' ? number_format($detail['product'][$k]['D05_TANKA']).'　円' : ''; ?></span>
                            </td>
                            <td class="tright" colspan="3">
                                <span class="rtab"><?php echo isset($detail['product'][$k]['D05_KINGAKU']) && $detail['product'][$k]['D05_KINGAKU'] != '' ? number_format($detail['product'][$k]['D05_KINGAKU']).'　円' : ''; ?></span>
                            </td>
                        </tr>
                    <?php } else { ?>
                        <tr>
                ...
                <tr class=" top_border">
                    ...
                    <td colspan="3"><?php echo isset($detail['D03_SUM_KINGAKU']) && $detail['D03_SUM_KINGAKU'] != '' ? number_format($detail['D03_SUM_KINGAKU']).' 円' : ''; ?></td>
                </tr>
                <tr>
            ...
            <table border="1px">
                ...
                <tr class="height2">
                    <td colspan="7" class="width7 tleft">
                        <p><?php echo nl2br($detail['D03_NOTE']); ?></p>
                    </td>
                    <td colspan="3" class="width3 sizeup"><?php echo $detail['D03_TANTO_SEI'] . '' . $detail['D03_TANTO_MEI']; ?></td>
                    <td colspan="3" class="width3 sizeup"><?php echo $detail['D03_KAKUNIN_SEI'] . '' . $detail['D03_KAKUNIN_MEI']; ?></td>

        ...
        <section>
            ...
            <table border="1px">
                <tr>
                    ...
                    <td colspan="5" class="width5 sizeup"><?php echo yii\helpers\Html::encode($post['D01_CUST_NAMEK']); ?></td>
                    <td colspan="9" rowspan="2" class="width9 tleft ttop">
                        <?php echo isset($post['D01_NOTE']) ? yii\helpers\Html::encode(nl2br($post['D01_NOTE'])) : ''; ?>
                    </td>
                </tr>
                <tr class="height2">
                    <td colspan="7" class="width7 sizeup"><?php echo yii\helpers\Html::encode($post['D01_CUST_NAMEN']); ?> 様</td>
                </tr>
            </table>
        </section>
        <section>
            ...
            <table border="1px">
                ...
                <tr>
                    ...
                    <td colspan="4" class="width4"><?php echo yii\helpers\Html::encode($post['D03_CAR_NAMEN']); ?></td>
                    <td colspan="3" class="width3"><?php echo isset($car['D02_SHONENDO_YM']) != '' ? substr($car['D02_SHONENDO_YM'],0,4).'年'.substr($car['D02_SHONENDO_YM'],4,2) . '月' : '' ?></td>
                    <td colspan="2"><?php echo isset($car['D02_TYPE_CD']) ? $car['D02_TYPE_CD'] : ''?></td>
                    <td colspan="3" class="width3 size"><?php echo isset($car['D02_GRADE_CD']) ? $car['D02_GRADE_CD'] : ''?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" class="width4"><?php echo $post['D03_JIKAI_SHAKEN_YM'] != '' ? Yii::$app->formatter->asDate(date('d-M-y', strtotime($post['D03_JIKAI_SHAKEN_YM'])), 'yyyy年MM月d日') : '' ?></td>
                    <td colspan="4" class="width4"><?php echo $post['D03_METER_KM'] ? $post['D03_METER_KM'].'<span>Km</span>' : ''; ?></td>
                    <td colspan="3" class="width3"><?php echo $post['D02_SYAKEN_CYCLE'] ? $post['D02_SYAKEN_CYCLE'].'<span>年</span>' : ''; ?></td>
                    <td colspan="5" class="width3">
                        <?php echo $post['D03_RIKUUN_NAMEN'] ?>
                        <?php echo $post['D03_CAR_ID'] ?>
                        <?php echo $post['D03_HIRA'] ?>
                        <?php echo $post['D03_CAR_NO'] ?>
                    </td>
                </tr>
            </table>
        </section>
            ...
            <table border="1px">
                <tr>
                    <td colspan="10" rowspan="2" class="width10 tleft ttop">
                        <p>備考</p>
                        <p><?php echo yii\helpers\Html::encode(nl2br($post['D03_NOTE'])); ?></p>
                    </td>

                    ...
                    <div id="section_discount">
                        ...
                        <?php
                            if($value['type'] == 'select') {
                                ...
                                echo \yii\helpers\Html::dropDownList('denpyo_inspection[DISCOUNT][]', in_array($key, $discount) ? array_search($key, $discount) : '', $value['discount'], array('class' => ['selectForm', 'select_discount']));
                            }
                            if($value['type'] == 'checkbox') {
                        ?>
                                <input <?php echo in_array($key, $discount) ? 'checked' : ''?> name="denpyo_inspection[DISCOUNT][]" value="<?php echo key($value['discount'])?>" type="checkbox" class="checks checkbox_discount">
                                <span class="spanSingleCheck <?php echo in_array($key, $discount) ? 'checked' : ''?>"><?php echo current($value['discount']); ?></span>
                        <?php
                            }
                        ?>
                                    <span class="txtUnit">円</span>

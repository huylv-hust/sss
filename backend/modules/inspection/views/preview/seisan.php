<main>
    ...
    <section class="" style="margin-top: 15px" >
        <div class="" style="width: 65%; float: left;">
            <div class="divTable">
                <p style="width: 50%;"></p>
                <p class="titleBox">ご精算書</p>
            </div>
            <div class="borderBottom height-line divTable" style="text-align: center">
                <p class="font30 marginB"><u><?php echo yii\helpers\Html::encode($customer['D01_CUST_NAMEN'])?> 様</u></p>
            </div>
    ...
    <section>
        <table border="1px" style="text-align: center">
            <tr>
                ...
                <th class="thColor">商品名</th>
                <th class="thColor" style="width: 15%">金額</th>
            </tr>
            <?php for ($i = 0; $i < 30; $i++) {?>
                <tr>
                    <td><?php echo $i+1;?></td>
                    <td style="text-align: left"><?php echo isset($products[$i]['M05_COM_NAMEN']) ? $products[$i]['M05_COM_NAMEN'] : ''?></td>
                    <td style="text-align: right"><?php echo isset($products[$i]['D05_KINGAKU']) ? number_format($products[$i]['D05_KINGAKU']) : ''?></td>
                </tr>
            <?php }?>

            <tr>
                <td colspan="2">②小　　計</td>
                <td style="text-align: right"><?php echo $denpyo['D03_SUM_KINGAKU'] ? number_format($denpyo['D03_SUM_KINGAKU']) : ''?></td>
            </tr>
        </table>
    </section>
    <section>
        <div class="font20" style="float: right; text-align: right;">
            <div style="border-bottom: solid black 1px">
                ...
                <div class="margin5">
                    <span>ご依頼整備合計:</span>
                    <input type="text" class="font20" style="width: 35%; border: solid black 1px; pointer-events: none; text-align: right" value="<?php echo $denpyo['D03_SUM_KINGAKU'] ? number_format($denpyo['D03_SUM_KINGAKU']) : ''?>">
                    <span> 円</span>
                </div>
            </div>
            <div style="border-bottom: solid black 1px">
                <div class="margin5">
                    <span>総合計:</span>
                    <?php $sum = $fee + $denpyo['D03_SUM_KINGAKU']?>
            ...
            <div style="border-bottom: solid black 1px">
                <div class="margin5">
                    <span>お預かり金額:</span>
                    <input type="text" class="font20" style="width: 35%; border: solid black 1px; pointer-events: none; text-align: right" value="<?php echo $earnest_money ? number_format($earnest_money) : ''?>">
                    <span> 円</span>
                </div>
            </div>
            <div class="margin5">
                <span>ご精算:</span>
                <?php $all =  $earnest_money - $sum?>
                <input type="text" class="font20" style="width: 35%; border: solid black 1px; pointer-events: none; text-align: right" value="<?php echo $all ? number_format($all) : ''?>">
                <span> 円</span>
            </div>
        </div>
    </section>

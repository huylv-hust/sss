                ...
                <tbody><tr>
                    ...
                    <tr>
                        ...
                        <td class="alRight">
                            ...
                            <a href="<?php echo \yii\helpers\BaseUrl::base(true).'/shaken/preview/osusume/'.$row['DENPYO_SUGGEST_NO'] ?>" target="_blank" class="btnFormTool">整備おすすめ</a>
                            <a href="<?php echo \yii\helpers\BaseUrl::base(true).'/shaken/preview/seisan/'.$row['DENPYO_SUGGEST_NO'] ?>" target="_blank" class="btnFormTool">精算書</a>
                            <?php if ($row['sign']) { ?>

    ...
    <div class="toolbar">
        ...
        <div class="toolbar-right" style="width: 60%">
            ...
            <a data-toggle="modal" target="_blank"
               ...
               href="<?php echo \yii\helpers\BaseUrl::base(true) . '/shaken/preview/seisan/' . $denpyo_inspection['DENPYO_SUGGEST_NO']; ?>">清算書（見積もり）</a>
            <a data-toggle="modal" target="_blank"
               class="btnTool marginBtn <?php echo isset($check_remove) ? $check_remove : '' ?>"
               style="<?php echo isset($check_remove) ? 'pointer-events: none;' : '' ?>"
               href="<?php echo \yii\helpers\BaseUrl::base(true) . '/shaken/preview/osusume/' . $denpyo_inspection['DENPYO_SUGGEST_NO']; ?>">おすすめ（見積もり）</a>

...
class FeeRegistration extends ActiveRecord
{
    ...
    public function getWhere($filters = [], $select = '*')
    {
        ...
        if (isset($filters['ID']) && $filters['ID']) {
            $query->andWhere('ID =:ID', [':ID' => $filters['ID']]);
        }
    ...
    {
        $command = \Yii::$app->db->createCommand('SELECT FEE_REGISTRATION_SEQ.nextval FROM dual');
